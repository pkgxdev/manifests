...
import { S3Client, ListObjectsV2Command } from 'npm:@aws-sdk/client-s3@3.743.0';
import SemVer, { compare } from "https://raw.githubusercontent.com/pkgxdev/libpkgx/v0.20.3/src/utils/semver.ts";
...
const versions = (await listObjects()).map(x => new SemVer(x)).sort(compare).join("\n");
