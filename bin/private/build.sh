...
eval "$(PATH="$(dirname "$deno"):$PWD/.pkgx/bin" PKGX_PANTRY_DIR="$SRCROOT/builds/pantry" PKGX_DIST_URL="https://dist.pkgx.dev/v2" PKGX_DIR="$PWD/.pkgx" $SRCROOT/bin/private/deps-env.ts $PKGSPEC)"
